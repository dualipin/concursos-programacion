import { editarConcurso, obtenerConcursos } from "@/servicios/concurso-serv";
import { useEffect, useState } from "react";

export default function ConcursoEditar() {
        ...
        <div className="container my-4">
            ...
            <form
                ...
                onSubmit={async (e) => {
                    ...
                    try {
                        const { clv, ...concursoData } = nuevoConcurso;
                        const response = await editarConcurso(clv, concursoData, criterios)
